...
const SamsungModal = ({samsungPhone, setsamsungPhone, refetch}) => {
    const {user} = useContext(AuthContext)
    const {category, date, email, image, location, prevPrice, price, product, seller, used} = samsungPhone
